...
- [Anti-patterns (selection-system author errors)](#anti-patterns-selection-system-author-errors)
...
> **Note (Phase A migration in progress):** the modal-comment-thread / queue-dir / atomic-write content below will be extracted into `${CLAUDE_PLUGIN_ROOT}/references/comment-chat-box.md` in a follow-up commit, with a pointer left here. Until then it lives inline.
