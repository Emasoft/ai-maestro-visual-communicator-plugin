...
- **Extends:** `--vc-font-features` (optional engine key) drives the
  ...
  [variable-font-tokens.md](./variable-font-tokens.md) for the
...
The agent picks fonts (via [font-loading-pairings.md](./font-loading-pairings.md))
...
- [code-and-mono.md](./code-and-mono.md) — programming ligatures on
