...
See [tabular-numerics.md](./tabular-numerics.md).
...
- [tabular-numerics.md](./tabular-numerics.md) — the digit-width
  contract pills' `.v` consumes.
- [code-and-mono.md](./code-and-mono.md) — the mono font the pill's
  `.v` uses.
