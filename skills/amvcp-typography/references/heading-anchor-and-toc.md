...
- **Reports printed to PDF** — anchors are useless on paper. The
  print stylesheet (see [print-and-paged-media.md](./print-and-paged-media.md))
...
- [code-and-mono.md](./code-and-mono.md) — the mono face the anchor
  "#" uses.
- [eyebrow-overline-label.md](./eyebrow-overline-label.md) — the TOC
