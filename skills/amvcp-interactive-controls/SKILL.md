...
description: "Self-contained interactive HTML control widgets — tabs, accordion, modal, filter pills, segmented control, stepper, virtualized list, sortable table, live-tweak visualizer, drag-reorder Kanban, before/after slider, glossary, code copy, live editor, checklist, theme toggle, sticky TOC, scroll-spy, keyboard shortcuts, search filter, slide deck, range picker, tag picker, breadcrumb, tooltip, popover, dialog, iframe sandbox, autosize textarea, lightbox, disclosure badge. All DESIGN.md-themed, state persists to localStorage. Use when the user wants any interactive widget — tabs, accordion, filterable list, step flow, windowed list, Kanban, comparison slider, sortable table, copy button, live editor, checklist, toggle, theme switcher, TOC, search box, slide deck, range/tag picker, breadcrumb, tooltip, modal/popover, sandboxed embed, autosizing textarea, or image lightbox. Trigger with 'tabs', 'accordion', 'collapsible', 'filter pills', 'segmented control', 'stepper', 'virtualized list', 'sortable table', 'live demo', 'kanban', 'drag to reorder', 'before/after', 'copy button', 'live editor', 'live diff', 'checklist', 'toggle', 'switch', 'theme switcher', 'dark mode', 'TOC', 'scroll spy', 'keyboard shortcut', 'search box', 'slide deck', 'range picker', 'tag picker', 'breadcrumb', 'tooltip', 'modal', 'popover', 'dialog', 'sandbox iframe', 'autosize textarea', 'lightbox'."
license: MIT
metadata:
  author: Emasoft
---
