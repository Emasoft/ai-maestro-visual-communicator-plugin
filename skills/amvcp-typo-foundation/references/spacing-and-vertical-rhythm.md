...
- [lists-and-list-typography.md](../../amvcp-typo-structure/references/lists-and-list-typography.md) —
  list-specific spacing (li margin) complements paragraph spacing.
- [measure-and-readability.md](../../amvcp-typo-structure/references/measure-and-readability.md) — the
