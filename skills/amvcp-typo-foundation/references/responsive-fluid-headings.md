...
- **Print-first deliverables** — use fixed `pt` sizes (see
  [print-and-paged-media.md](../../amvcp-typo-i18n-print/references/print-and-paged-media.md)) — the
...
- [tabular-numerics.md](../../amvcp-typo-microtype/references/tabular-numerics.md) — the `.vc-type-stat-hero`
