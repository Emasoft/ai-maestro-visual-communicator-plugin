...
- [language-and-locale.md](../../amvcp-typo-i18n-print/references/language-and-locale.md) — `<q lang>`
  drives the per-language quote glyphs.
- [emphasis-and-strong.md](../../amvcp-typo-editorial/references/emphasis-and-strong.md) — sibling
  inline-typography contracts.
- [pull-quote-and-blockquote.md](../../amvcp-typo-editorial/references/pull-quote-and-blockquote.md) —
