---
name: amvcp-layout
description: "Build DESIGN.md-themed HTML layouts — content+sidebar grids, 3-panel IDE shells, 12-column dashboards, KPI rows, scroll-spy TOCs, sticky headers (opaque + glassmorphism), fluid clamp() headings, A4 print layouts, device-mockup frames, hero backgrounds. Use when the user asks for a layout, grid, sidebar, dashboard, TOC, print/PDF, sticky header, hero, device mockup. Trigger with 'layout', 'grid', 'sidebar', 'dashboard', 'TOC', 'print', 'A4', 'sticky header', 'glassmorphism', 'hero', 'device mockup'."
license: MIT
