...
The hierarchy contract (B.3 in [semantic-hierarchy.md](../../amvcp-typo-foundation/references/semantic-hierarchy.md))
...
- [semantic-hierarchy.md](../../amvcp-typo-foundation/references/semantic-hierarchy.md) — the role table
