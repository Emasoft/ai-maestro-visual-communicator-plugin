...
- [Mandatory boilerplate](#mandatory-boilerplate)
- [The selection payload](#the-selection-payload)
- [What to make selectable](#what-to-make-selectable)
- [Marking elements](#marking-elements)
- [Mermaid integration](#mermaid-integration)
- [Chart.js integration](#chartjs-integration)
- [Regex visualizer + editor (.ve-regex)](#regex-visualizer--editor-ve-regex)
- [Tables — three modes](#tables--three-modes)
- [When to use form mode vs. passive mode](#when-to-use-form-mode-vs-passive-mode)
- [Prose mode — paragraph numbering + text-snippet selection](#prose-mode--paragraph-numbering--text-snippet-selection)
- [Math / LaTeX (KaTeX, with chemistry via mhchem)](#math--latex-katex-with-chemistry-via-mhchem)
- [Engine routing — read this BEFORE generating a graph](#engine-routing--read-this-before-generating-a-graph)
- [Graphviz cookbook — defaults that work](#graphviz-cookbook--defaults-that-work)
- [TikZJax limitations & substitutions](#tikzjax-limitations--substitutions)
- [Directed graphs (Graphviz / .ve-graph)](#directed-graphs-graphviz--ve-graph)
- [Slides](#slides)
- [Runner-process pitfalls (Chrome --app=URL mode)](#runner-process-pitfalls-chrome---appurl-mode)
- [Anti-patterns](#anti-patterns)
- [Inlining the runtime (single-file portability)](#inlining-the-runtime-single-file-portability)
- [Future extensions (not yet implemented)](#future-extensions-not-yet-implemented)
