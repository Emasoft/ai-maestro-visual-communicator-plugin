...
- [font-loading-pairings.md](../../amvcp-typo-foundation/references/font-loading-pairings.md) — the System
  pairing's font-body includes CJK fallbacks implicitly via
  `system-ui` on CJK platforms.
- [emphasis-and-strong.md](../../amvcp-typo-editorial/references/emphasis-and-strong.md) — the Latin
