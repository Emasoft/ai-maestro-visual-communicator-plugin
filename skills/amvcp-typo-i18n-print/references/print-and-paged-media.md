...
rule (see [multi-column-layout.md](../../amvcp-typo-structure/references/multi-column-layout.md)).
...
- [multi-column-layout.md](../../amvcp-typo-structure/references/multi-column-layout.md) — multi-column
  has its own widow/orphan rules; print interacts with both.
- [code-and-mono.md](../../amvcp-typo-code-keys/references/code-and-mono.md) — `<pre>` has no inner
